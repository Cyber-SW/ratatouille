        ...
        <div>
            ...
            <div className="hero-section">
                <div className="hero-content">
                    ...
                    <button type="button" onClick={handleGetStarted}>Try out now</button>
                </div>
            </div>
            ...
            <section className="about-section">
                <div className="about-section-align">
                    <div className="about-desktop">
                        ...
                        <p className="about-section-text">This is the final project of my Ironhack experience and was created within 9 days and for educational purposes only. Want to hire me?</p>
                    </div>
